...
type PlaylistRepository interface {
	...
	GetListPlaylistByUserID(ctx context.Context, userID int) (playlists []entities.DetailPlaylist, err error)
	GetPlaylistWithSongs(ctx context.Context, playlistID uuid.UUID, userID int) (playlist *entities.ExportPlaylist, err error)
}
